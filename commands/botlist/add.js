...
$onlyIf[$and[$db[get;botlist_bot_$get[x]]==;$db[get;botlist_waiting_$get[x]]==]==true;
...
db.set('main', 'botlist_waiting_' + d.object.snowflake, $getObject)
